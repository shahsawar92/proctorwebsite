...
import '../style.css'
import './style.css'
export default function DiscriptionProctor() {
  return <div className='h-60'>
        <div className='bg-white h-20 my-2 grid grid-cols-1 border rounded-lg p-2'>
            <div className='grid grid-cols-12 disc-t'>
                ...
                <div className='col-span-2 disc-t1 font-bold'>Type 1 02</div>
                <div className='col-span-2'>Start: 8:30 hrs</div>
                <div className='col-span-2'>End: 10.30 hrs</div>
                <div className='col-span-4'>Time Remaining: 01:11 hrs</div> 
            </div>
  ...
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
             ...
             <button id='accept' className=" bg-blue-500  disc text-white  w-12 h-8   rounded">
                 Take
            </button>
            </div>
