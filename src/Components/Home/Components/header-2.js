...
{/* Candidate varification */}
            <div  id="btn-1" className='pointer text-white lg:text-sm font-medium 2xl:py-2 lg:py-2 lg:w-48 lg:px-2 w-32 py-2 px-1 text-xs 2xl:w-60 mt-2  rounded-lg  2xl:px-2 flex justify-between'> <div onClick={()=>{setshowModal(true) }}> Candidate varification </div><div className='icon'> <BsFillPatchCheckFill fontSize="1.3em" /></div> </div>
{/* Proctor Group Chat */}
            <div  id="btn-2" className=' hover:bg-blue-300 text-white lg:text-sm font-medium 2xl:py-2 lg:py-2 2xl:w-60 lg:w-44 rounded-lg w-32 py-2 px-1 mt-2 text-xs  2xl:px-6 lg:px-2 flex justify-between'><div> Proctor Group Chat</div> <div className='icon' > <IoMdChatboxes fontSize="1.5em" /></div></div>
{/* Status */}
