    ...
    return (
        <div className="relative flex flex-col">
            <div className="flex flex-row">
                <img  className="h-auto self-center " src={positions[0]} alt="profile" style={{ height: '220px', width: '150px'}} />
                <img  className="h-auto  self-center" src={positions[1]} alt="books" style={{ height: '220px', width: '150px' }} />
            </div>
