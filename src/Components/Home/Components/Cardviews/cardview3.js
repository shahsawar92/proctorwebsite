    ...
    return (
        <div className="relative flex flex-col">
            <div className="flex flex-row">
                <div className="relative flex flex-col">
                    <div>
                        <img  className="w-28 h-full self-center " src={positions[0]} alt="profile" style={{ width: '400px' }} />
                    </div>

                    <div className="absolute bottom-2 right-5">
                        <img  className="w-28 h-full  self-center" src={positions[1]} alt="books" />
                    </div>
                    <img className='place-self-end  -mt-10 pr-2 w-10 h-7 text-green-900 change-position-btn' src={cameraicon} alt='camera' style={{ zIndex: '1' }} onClick={() => {
