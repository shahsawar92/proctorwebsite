        ...
        <div>
            ...
            <div className="md:flex md:items-center md:justify-end mb-6">
                    ...
                    <div className="md:flex md:items-center md:justify-end mb-6">  
                        ...
                        <input className="bg-blue-100 appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 text-sm" id="inline-full-name" type="text" placeholder='User Name' />
                        </div>
                    </div>
                    ...
                    <div className="md:flex md:items-center md:justify-end mb-6">  
                        ...
                        <input className="bg-blue-100 appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 text-sm" id="inline-full-name" type="text" placeholder='Email Address' />
                        </div>
                    </div>
                    ...
                    <div className="md:flex md:items-center md:justify-end mb-6">
                        ...
                        <input className="bg-blue-100 appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 text-sm" id="inline-password" type="password" placeholder="8+ characters" />
                        </div>
                    </div>
                    ...
                    <div className="md:flex md:items-center md:justify-end mb-8">  
                        ...
                        <input className="bg-blue-100 appearance-none border-2 border-gray-200 rounded-xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 text-sm" id="inline-full-name" type="text" placeholder='8+ characters' />
                        </div>
                    </div>
